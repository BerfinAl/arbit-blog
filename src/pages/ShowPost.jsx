...
export default function ShowPost({ posts }) {
  ...
  const commentElements =
    ...
    comments.map((comment) => {
      return (
        <div className="flex flex-col pb-3" key={comment.id}>
  ...
  return (
    <>
      {isObjectEmpty(post) || post === undefined || post === null ? (
        <NotFound />
      ) : (
